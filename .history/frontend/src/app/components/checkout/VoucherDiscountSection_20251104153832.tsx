...
const VoucherDiscountSection: React.FC<Props> = ({
  ...
  const fetchAvailableVouchers = async () => {
    ...
    try {
      ...
      // Fetch usable vouchers
      const allVouchers = await userVoucherApi.getUsableVouchers(storeId, filterByStore);

      console.log('📦 [VoucherModal] Loaded vouchers:', allVouchers.length);

      // Fetch collected vouchers
      const my = await userVoucherApi.getCollectedVouchers();
      setMyVouchers(my);

      // Extend usable vouchers with is_collected
