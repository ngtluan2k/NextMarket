            ...
            customer.id === editingCustomer.id
              ? {
                  ...
                  lastOrderDate: values.lastOrderDate
                    ? values.lastOrderDate.format('YYYY-MM-DD')
                    : undefined,
                }
              : customer
          )
    ...
    },
    {
      ...
      render: (status: string) => (
        <Tag
          ...
          className="border-0"
          icon={status === 'VIP' ? <StarOutlined /> : undefined}
        >
          {status}
        </Tag>
      ),
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <Text className="text-gray-500">
              Quản lý cơ sở dữ liệu và mối quan hệ với khách hàng
            </Text>
          </div>
          <Space>
          ...
          <Table
            ...
            pagination={{
              ...
              showTotal: (total, range) =>
                `${range[0]}-${range[1]} trên tổng số ${total} khách hàng`,
            }}
            scroll={{ x: 1200 }}
        ...
        >
          <Form form={form} layout="vertical" className="mt-4">
            ...
            <Form.Item name="notes" label="Ghi Chú">
              <Input.TextArea
                rows={3}
                placeholder="Nhập ghi chú bổ sung về khách hàng"
              />
            </Form.Item>
          </Form>
        </Modal>
