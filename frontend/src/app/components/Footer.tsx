...
export type Social = { name: "facebook" | "youtube" | "tiktok" | "instagram"; href: string };
      ...
      <div className="mx-auto max-w-screen-2xl px-4">
        ...
        <div className="grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h4 className="mb-3 text-sm font-bold text-slate-900">Kết nối với chúng tôi</h4>
            ...
            <div className="mt-6">
              <h5 className="mb-2 text-xs font-semibold text-slate-900">Tải ứng dụng</h5>
        ...
        <div className="grid gap-6 border-t border-slate-200 py-8 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            <h5 className="mb-3 text-xs font-semibold text-slate-900">Phương thức thanh toán</h5>
          ...
          <div>
            <h5 className="mb-3 text-xs font-semibold text-slate-900">Đối tác vận chuyển</h5>
            <div className="flex flex-wrap gap-2">
              {shippings.map((s, i) => (
                <Tag key={i} label={s} />
              ))}
          ...
          <div className="lg:text-right">
            <h5 className="mb-3 text-xs font-semibold text-slate-900">Chăm sóc khách hàng</h5>
            <p className="text-xs text-slate-700">
              Hotline: <a href="tel:19001234" className="font-semibold text-sky-600">1900 1234</a> (8:00 - 21:00)
            </p>
            <p className="mt-1 text-xs text-slate-700">
              Email: <a href="mailto:cs@everymart.vn" className="font-semibold text-sky-600">cs@everymart.vn</a>
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 py-4 text-center sm:text-left">
          <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
              {bottomLinks.map((b, i) => (
                <a key={i} href={b.href} className="text-[11px] text-slate-600 hover:text-slate-900 hover:underline">
                  {b.label}
                </a>
              ))}
            </div>
