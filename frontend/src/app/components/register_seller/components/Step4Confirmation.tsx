    ...
    <div className="rounded-2xl border border-slate-100 bg-white shadow-sm">
      ...
      <div className="px-5 py-6 text-center">
        ...
        <div className="mx-auto mt-4 max-w-2xl text-left">
          ...
          <h6 className="mt-3 text-xs font-semibold text-slate-800">Thông tin kinh doanh:</h6>
          <ul className="mt-1.5 list-disc space-y-0.5 pl-5 text-sm text-slate-700">
          ...
          <h6 className="mt-3 text-xs font-semibold text-slate-800">Thông tin ngân hàng:</h6>
          <ul className="mt-1.5 list-disc space-y-0.5 pl-5 text-sm text-slate-700">
        ...
        <div className="mt-6 flex justify-center">
          <button
            className="inline-flex items-center rounded-lg bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-60"
