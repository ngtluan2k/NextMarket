...
import { Card, Button, Typography, Image, InputNumber, Divider, Row, Col, Empty } from "antd"
    ...
    <div style={{ minHeight: "100vh", padding: "24px", backgroundColor: "#f5f5f5" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
          <Button icon={<ArrowLeftOutlined />} type="text" size="large" onClick={() => window.history.back()} />
          <div>
        ...
        {cart.length === 0 ? (
          <Card style={{ textAlign: "center", padding: "64px 24px" }}>
            ...
            >
              <Button type="primary" size="large" style={{ marginTop: 16 }} onClick={() => window.history.back()}>
                Continue Shopping
              </Button>
            </Empty>
          </Card>
          ...
          <Row gutter={24}>
                  ...
                  <Card key={item.id} style={{ borderRadius: 12 }}>
                    <div style={{ display: "flex", gap: 16 }}>
                      <div style={{ width: 80, height: 80, flexShrink: 0 }}>
                        <Image
                          src={item.product.image || "/placeholder.svg?height=80&width=80&query=product thumbnail"}
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <Title level={4} style={{ margin: "0 0 8px 0" }} ellipsis>
                          {item.product.name}
                        </Title>
                        ...
                        >
                          ...
                          <Button
                            ...
                            danger
                            icon={<DeleteOutlined />}
                            onClick={() => handleRemoveFromCart(item.product_id, item.product.name)}
                          >
                            Remove
                          </Button>
                        </div>
            ...
            <Col xs={24} lg={8}>
              <Card title="Order Summary" style={{ borderRadius: 12, position: "sticky", top: 24 }}>
                ...
                <Button type="primary" size="large" block style={{ borderRadius: 8 }}>
                  Proceed to Checkout
                </Button>
              </Card>
            </Col>
