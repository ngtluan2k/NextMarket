...
//       navigate('/', {
//         state: { error: 'Không có thông tin sản phẩm để đặt hàng' },
//       });
//       return;
//     }
...
//       total,
//     });
//     console.log('📊 Order preview updated:', {
//       subtotal,
//       shippingFee,
//       paymentFee,
//       discount,
...
//                   {product.store?.name || 'Tiki Trading'}
//                 </span>
