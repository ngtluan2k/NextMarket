    ...
    return (
        <div className="w-full border-b bg-sky-50">
            <div className="mx-auto max-w-screen-2xl px-4 py-3">
                {loading ? (
                    <div className="text-slate-600 text-sm">Đang tải thông tin nhóm...</div>
                ) : error ? (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-slate-600">
                                        Trạng thái: {group?.status} • Mã tham gia: {group?.join_code ?? '—'}
                                    </div>
                                </div>
                            </div>
                        ...
                        {showInvite && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
                                <div className="w-full max-w-lg rounded-xl bg-white p-4 shadow-xl">
                                    <div className="mb-3 text-base font-semibold">Chia sẻ liên kết tham gia</div>
