...
export default function AccountSecurityPanel({
  ...
  const [localPhone, setLocalPhone] = useState<string | null | undefined>(
    undefined
  );
  const [localEmail, setLocalEmail] = useState<string | null | undefined>(
    undefined
  );
  ...
  const body = (
    <div className={className}>
      ...
      <h3 className="text-sm font-semibold text-slate-900 mt-6 mb-2">
        Bảo mật
      </h3>
      <div className="space-y-2">
        <Row
        ...
        <Row
          icon={
            <svg className="h-4 w-4" viewBox="0 0 48 48">
              <path
                fill="#FFC107"
                d="M43.6 20.5H42V20H24v8h11.3C33.6 31.8 29.2 35 24 35c-6.6 0-12-5.4-12-12S17.4 11 24 11c3 0 5.7 1.1 7.8 2.9l5.7-5.7C33.8 5.4 29.1 3.5 24 3.5 12.1 3.5 2.5 13.1 2.5 25S12.1 46.5 24 46.5 45.5 36.9 45.5 25c0-1.5-.2-3-.6-4.5z"
              />
              <path
                fill="#FF3D00"
                d="M6.3 14.7l6.6 4.8C14.7 16.6 18.9 13 24 13c3 0 5.7 1.1 7.8 2.9l5.7-5.7C33.8 5.4 29.1 3.5 24 3.5c-7.9 0-14.9 4.6-17.7 11.2z"
              />
              <path
                fill="#4CAF50"
                d="M24 46.5c5 0 9.7-1.9 13.2-5.2l-6.1-5c-2 1.4-4.6 2.2-7.1 2.2-5.2 0-9.6-3.2-11.2-7.8l-6.6 5C9.1 41.9 16 46.5 24 46.5z"
              />
              <path
                fill="#1976D2"
                d="M43.6 20.5H42V20H24v8h11.3c-1.6 3.8-5.4 6.5-9.3 6.5-5.2 0-9.6-3.2-11.2-7.8l-6.6 5C9.1 41.9 16 46.5 24 46.5c11.9 0 21.5-9.6 21.5-21.5 0-1.5-.2-3-.6-4.5z"
              />
            </svg>
          }
          title="Google"
  ...
  return framed ? (
    <aside className="rounded-2xl bg-white ring-1 ring-slate-200 shadow p-5">
      {body}
    </aside>
  ) : (
    body
