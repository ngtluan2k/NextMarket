...
export default function StoreTopBar({
  ...
  return (
    <header className={[sticky ? "sticky top-0 z-40" : "", className ?? ""].join(" ")}>
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <div className="truncate text-base font-semibold text-slate-900">
                      {loading ? <span className="inline-block h-4 w-40 animate-pulse rounded bg-slate-200" /> : info?.name}
                    </div>
                    {!!info?.isOfficial && (
                  ...
                  <div className="mt-0.5 flex flex-wrap items-center gap-2 text-xs text-slate-600">
                    {typeof info?.rating === "number"
                      ...
                      : loading ? <span className="inline-block h-3 w-20 animate-pulse rounded bg-slate-100" /> : null}
                ...
                <li key={t.href}>
                  <Link
                    ...
                    className={[
                      ...
                      isActiveTab(t) ? "font-semibold text-slate-900" : "text-slate-600 hover:text-slate-900",
                    ].join(" ")}
