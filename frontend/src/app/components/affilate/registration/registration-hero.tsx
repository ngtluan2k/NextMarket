...
const steps = [
  {
    icon: ShoppingBag,
    title: "Tìm sản phẩm",
    description: "Duyệt qua hàng nghìn sản phẩm chất lượng trong danh mục của chúng tôi",
    gradient: "from-orange-500 to-orange-600",
  },
  {
    icon: Share2,
    title: "Chia sẻ sản phẩm",
    description: "Quảng bá sản phẩm đến khán giả của bạn qua các nền tảng mạng xã hội",
    gradient: "from-orange-600 to-red-500",
  },
  {
    icon: DollarSign,
    title: "Thu nhập từ các đơn hàng",
    description: "Nhận hoa hồng hấp dẫn cho mỗi đơn hàng thành công từ liên kết của bạn",
    ...
    <div className="relative overflow-hidden bg-gradient-to-r from-orange-500 via-orange-600 to-red-500 py-12 shadow-xl">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <h2 className="text-center text-2xl font-bold text-white">3 Bước để có Hoa Hồng</h2>
          <Sparkles className="h-6 w-6 text-white animate-pulse" />
        </div>
